...
const employeeItems = [
  ...
  {
    name: "Tasks", href: "/employee/my-tasks",
  ...
  {
    name: "Projects", href: "/employee/projects",
...
const employeeBottomItems = [
  {
    name: "Settings", href: "/employee/settings",
  ...
  return (
    <NotificationProvider>
      <div className="h-screen bg-slate-50 flex flex-col overflow-hidden">
        <Navbar userInitial="A" userName="Adrian Cole" />
        <div className="flex flex-1 overflow-hidden">
          <Sidebar
            items={employeeItems}
            bottomItems={employeeBottomItems}
            userInfo={{ name: "Adrian Cole", role: "Employee", initial: "A" }}
            brand={{ name: "DeepRank", sub: "Employee Suite" }}
          />
